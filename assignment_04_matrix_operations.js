...
function main() {
    ...
    let matrix1 = readMatrix(rows, cols, "Matrix A");
    let matrix2 = readMatrix(rows, cols, "Matrix B");
    ...
    let matrixA = readMatrix(m, n, "Matrix A");
    let matrixB = readMatrix(n, p, "Matrix B");
